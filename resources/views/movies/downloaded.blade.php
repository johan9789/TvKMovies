...
<link rel="stylesheet" href="{{ URL::asset('news-css/news.css') }}" type="text/css" media="all" />
<link rel="stylesheet" href="{{ URL::asset('list-css/list.css') }}" type="text/css" media="all" />
